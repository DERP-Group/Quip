...
//		RADIO("You have a beautiful voice and memorable face. <break strength=\"weak\" /> Which makes you perfect for radio."), // You have a beautiful voice, and a face for radio. (reword)
		...
		ACCENT("I wish I had your accent. Then I could drink on the job and no one would know."),	// you have slurred speech like a drunk (reword?)
